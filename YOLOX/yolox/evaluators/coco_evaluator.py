...
class COCOEvaluator:
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            outs = self.convert_to_coco_format(outputs, info_imgs, ids)
            data_list.extend(outs)
            backdata_list.extend(outs)
        if saveResr:
            with open(out_file, 'w')as f: json.dump({"annotations":backdata_list}, f, indent=0)
        del backdata_list
