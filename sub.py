...
if __name__ == "__main__":
    ...
    parser.add_argument('--phase', type=str, default="phase2", choices={"phase1", "phase2", "phase3"})
    parser.add_argument('--jp', type=str, required=True, help="Path to submission json")
